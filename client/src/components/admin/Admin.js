        ...
        (
          ...
          <div className="container-fluid p-0 overflow-hidden">
            <div className="d-flex">
              <div>
                { adminauth.isAuthenticate && <Appbar />}
                </div>
              <div className="main">
                <Switch>
                  ...
                  />
                  <PrivateRoute exact path="/admin/coupons" component={ViewCoupon} />
                  <PrivateRoute exact path="/admin/products" component={ViewProducts} />
                  <PrivateRoute exact path="/admin/merchant" component={Return} />
                  <PrivateRoute exact path="/admin/add-coupon" component={AddCoupon} />
                  <PrivateRoute exact path="/admin/orders" component={ViewOrders} />
